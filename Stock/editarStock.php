...
// Obtiene el id del registro de stock a editar
$id = intval($_GET["id"]);

// Recupera el registro de stock con el nombre del producto asociado
...
// Si se envía el formulario de actualización de stock
if (isset($_POST["actualizar"])) {
    ...
    // Actualiza el registro de stock en la base de datos
